          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-green">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Booking Complete</span>
                <span class="info-box-number"><?=select_num($Sql);?></span>
                <div class="progress"><div class="progress-bar" style="width: 100%"></div></div>
                <span class="progress-description">All Booking Complete</span>
              </div>
            </div>
          </div>
          <?
  ...
  <div class="col-lg-12 col-md-12 col-xs-12">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#view_booking" data-toggle="tab"> Booking Complete <?=select_num($SqlViewBooking)>0?"( ".select_num($SqlViewBooking)." )":"";?></a></li>
      </ul>
                        ...
                        foreach (select_tb($SqlViewBooking) as $row) {
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <div class="btn-group" style="min-width:195px;">
